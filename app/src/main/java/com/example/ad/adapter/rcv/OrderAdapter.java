...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder>{
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_check_out, parent, false)
        );
    }
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        holder.textAcceptedCheckOut.setOnClickListener(view -> clickItem.acceptedCheckOut(order));
    }
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        private TextView txtId, txtCreatedAt, txtStatus, textAcceptedCheckOut;
        ...
        private void _init(View view) {
            ...
            textAcceptedCheckOut = view.findViewById(R.id.textAcceptedCheckOut);
        }
        ...
        public void onBindViewHolder(final Order order) {
            ...
            int isVisible = (order.isStatus()) ? View.GONE : View.VISIBLE;
            textAcceptedCheckOut.setVisibility(isVisible);
        }
    }

    public interface ClickItem {
        void showDetails(final Order order);
        void acceptedCheckOut(final Order order);
    }
}
