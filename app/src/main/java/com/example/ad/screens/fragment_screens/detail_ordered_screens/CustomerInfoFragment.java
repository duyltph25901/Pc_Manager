...
public class CustomerInfoFragment extends Fragment {
    ...
    private View view;
    private TextView textFullName, textPhoneNumber, textEmail, textAddress;
    ...
    private void _init() {
        ...
        Log.d("CheckBill", bill.getIdOrder());
        order = Realtime.foundOrderById(bill.getIdOrder());
        Log.d("CheckOrderFound", order.getId()+"") ;

        // ui
        textFullName = view.findViewById(R.id.textCustomerName);
        textPhoneNumber = view.findViewById(R.id.textPhoneNumber);
        textEmail = view.findViewById(R.id.textEmail);
        textAddress = view.findViewById(R.id.textAddress);
    }

    private void _setDataView() {
        textFullName.setText("Tên khách hàng: " + order.getInfoUser().getFullName().toUpperCase());
        textEmail.setText("Email: " + order.getInfoUser().getEmail());
        textPhoneNumber.setText("Số điện thoại: " + order.getInfoUser().getPhoneNumber());
        textAddress.setText("Địa chỉ: " + order.getInfoUser().getAddress());
    }
}